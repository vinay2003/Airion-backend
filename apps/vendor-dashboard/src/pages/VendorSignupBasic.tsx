...
const VendorSignupBasic: React.FC = () => {
 ...
 <CheckCircle className="w-16 h-12 text-green-600 dark:text-green-400" />
 </div>
 </div>
 <h2 className="text-lg font-bold mb-2 text-gray-900 dark:text-white">Phone Verified!</h2>
 ...
 className="w-full bg-red-600 hover:bg-neutral-900 transition-all text-white h-12 text-base font-bold shadow-red-500/10 active:scale-[0.98]"
 disabled={loading}
 >
 {loading ? (
