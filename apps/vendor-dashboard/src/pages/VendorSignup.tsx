...
const VendorSignupWizard: React.FC = () => {
 ...
 className={`h-full ${currentStep > step ? 'bg-emerald-500' : 'bg-red-500 '}`}
 />
 </div>
 ))}
 </div>
 ...
 {currentStep === 1 && (
 <div key="step1" className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div className="md:col-span-2 space-y-2">
 <label className="text-xs font-bold text-slate-500 uppercase tracking-widest pl-1">Legal Business Name</label>
 <div className="relative group">
 <Building className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-red-500 transition-colors" size={16} />
 ...
 <div className="relative group">
 <Globe className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-red-500 transition-colors" size={16} />
 ...
 <div className="relative group">
 <Phone className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-red-500 transition-colors" size={16} />
 ...
 <div className="relative group">
 <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-red-500 transition-colors" size={16} />
 ...
 <h3 className="text-xl font-bold flex items-center gap-2"><Globe className="text-blue-400" size={16} /> Customer Sources</h3>
 ...
 <input type="number" name="averageBookingPrice" value={formData.averageBookingPrice} onChange={handleTextChange} placeholder="e.g. 150000" className="w-full bg-slate-900/50 border border-slate-800 rounded-xl py-4 px-4 outline-none focus:border-red-500/50 transition-all font-bold text-lg text-emerald-500" />
 </div>
 </div>
 </div>
 )}
 ...
 <div>
 <h3 className="text-xl font-bold flex items-center gap-2"><Camera className="text-emerald-400" size={16} /> Portfolio Gallery</h3>
 ...
 <div key={i} className="aspect-square rounded-2xl overflow-hidden relative group border border-slate-800">
 ...
 <button type="submit" disabled={submitting} className={`flex-[2] py-5 rounded-3xl font-bold text-lg transition-all flex items-center justify-center gap-3 active:scale-[0.98] ${
 currentStep === 3 
