        ...
        <main className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
            ...
            <section className="pb-20 px-4 md:px-8">
                <div className="max-w-5xl mx-auto bg-red-600 rounded-3xl p-12 md:p-20 text-center text-white shadow-2xl shadow-red-600/30">
                    ...
                    <Link to="/signup?portal=vendor" className="inline-block bg-white text-red-600 px-12 py-5 rounded-full font-bold text-xl hover:bg-gray-100 transition-all shadow-lg ">
                        Join as a Vendor
                    </Link>
