    ...
    >
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10 pt-0 pb-12 border-b border-[var(--ease2event-border-subtle)] relative overflow-hidden">
        ...
        <motion.div variants={itemVariants} className="flex items-center gap-3 sm:gap-4 relative z-10 w-full lg:w-auto">
          <Button className="flex-1 sm:flex-none flex items-center justify-center bg-[var(--ease2event-bg-elevated)] h-11 sm:h-12 px-4 sm:px-8 rounded-2xl border border-[var(--ease2event-border-subtle)] font-bold text-[9px] sm:text-[11px] uppercase tracking-widest text-[var(--ease2event-text-primary)] hover:bg-[var(--ease2event-bg-surface)] transition-all active:scale-95 whitespace-nowrap">
            <CalendarIcon size={14} className="mr-2 sm:mr-3" />
            Custom Period
          </Button>
          <Button className="flex-1 sm:flex-none flex items-center justify-center h-11 sm:h-12 px-4 sm:px-10 rounded-2xl font-bold text-[9px] sm:text-[11px] uppercase tracking-widest bg-[var(--ease2event-brand-primary)] text-white shadow-2xl hover:scale-105 transition-all active:scale-95 whitespace-nowrap">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        <motion.div variants={itemVariants} whileHover={{ y: -8, scale: 1.02 }} className="card-minimal p-6 sm:p-10 flex flex-col justify-between hover:border-emerald-500/40 hover:shadow-2xl transition-all duration-500 bg-[var(--ease2event-bg-surface)]">
          <div>
            ...
            <p className="text-[var(--ease2event-text-secondary)] font-bold text-[10px] sm:text-[11px] uppercase tracking-widest mb-3 sm:mb-4">Total Balance</p>
            <h2 className="text-4xl sm:text-5xl font-bold text-[var(--ease2event-text-primary)] tracking-tighter leading-none">₹{displayData.totalBalance.toLocaleString('en-IN')}</h2>
          </div>
          <div className="mt-10 pt-8 border-t border-[var(--ease2event-border-subtle)]">
            <button className="flex items-center justify-between w-full p-5 bg-[var(--ease2event-bg-surface)] hover:bg-[var(--ease2event-bg-elevated)] border-2 border-[var(--ease2event-border-subtle)] rounded-[2rem] transition-all group active:scale-95 shadow-inner">
              <span className="text-[11px] font-bold text-[var(--ease2event-text-primary)] uppercase tracking-widest flex items-center gap-3">
        ...
        <motion.div variants={itemVariants} whileHover={{ y: -8, scale: 1.02 }} className="card-minimal p-6 sm:p-10 flex flex-col justify-between hover:border-[var(--ease2event-brand-primary)]/40 hover:shadow-2xl transition-all duration-500 bg-[var(--ease2event-bg-surface)]">
          <div>
            <div className="flex justify-between items-start mb-6 sm:mb-10 relative">
              ...
              <div className="flex items-center gap-2 text-emerald-600 text-[9px] sm:text-[11px] font-bold bg-emerald-500/10 px-3 sm:px-4 py-1.5 sm:py-2 rounded-2xl border border-emerald-500/20 uppercase tracking-widest">
                <ArrowBigUpDash size={16} />
                <span>{displayData.growth}</span>
              </div>
            </div>
            <p className="text-[var(--ease2event-text-secondary)] font-bold text-[10px] sm:text-[11px] uppercase tracking-widest mb-3 sm:mb-4">{activePeriod} Revenue</p>
            <h2 className="text-4xl sm:text-5xl font-bold text-[var(--ease2event-text-primary)] tracking-tighter leading-none">₹{displayData.periodRevenue.toLocaleString('en-IN')}</h2>
          </div>
          <div className="flex items-center gap-4 mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-[var(--ease2event-border-subtle)]">
            ...
            <p className="text-[9px] sm:text-[10px] text-[var(--ease2event-text-secondary)] font-bold uppercase tracking-[0.2em] leading-none">Nodes Updated <span className="text-emerald-600">Live Telemetry</span></p>
          </div>
        </motion.div>
        ...
        <motion.div variants={itemVariants} whileHover={{ y: -8, scale: 1.02 }} className="card-minimal p-6 sm:p-10 flex flex-col justify-between hover:border-amber-500/40 hover:shadow-2xl transition-all duration-500 bg-[var(--ease2event-bg-surface)]">
          <div className="flex justify-between items-start mb-6 sm:mb-8">
            <div className="flex-1">
              <p className="text-[var(--ease2event-text-secondary)] font-bold text-[10px] sm:text-[11px] uppercase tracking-widest mb-1 sm:mb-2">Monthly Target</p>
              <h3 className="text-2xl sm:text-3xl font-bold text-[var(--ease2event-text-primary)] tracking-tighter uppercase leading-none">₹{displayData.payoutTarget.toLocaleString()} GOAL</h3>
            </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex justify-between items-center text-[8px] sm:text-[10px] font-bold uppercase tracking-widest text-[var(--ease2event-text-secondary)] leading-none">
          ...
          <button className="mt-8 sm:mt-10 flex items-center justify-between w-full p-4 sm:p-5 bg-[var(--ease2event-bg-surface)] hover:bg-[var(--ease2event-bg-elevated)] border-2 border-[var(--ease2event-border-subtle)] rounded-[1.5rem] sm:rounded-[2rem] transition-all group active:scale-95 shadow-inner">
            <span className="text-[10px] sm:text-[11px] font-bold text-[var(--ease2event-text-primary)] uppercase tracking-widest leading-none">Modify Target Matrix</span>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-10">
        <motion.div variants={itemVariants} className="xl:col-span-2 card-minimal !p-10 flex flex-col bg-[var(--ease2event-bg-surface)] shadow-2xl overflow-hidden relative">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-10 mb-16 relative z-10">
            <div>
              <h3 className="text-3xl font-bold text-[var(--ease2event-text-primary)] tracking-tight uppercase leading-none">Revenue Trends</h3>
              <p className="text-[11px] text-[var(--ease2event-text-secondary)] font-bold uppercase tracking-widest mt-4">Performance tracking across selected periods</p>
            </div>
            <div className="bg-[var(--ease2event-bg-elevated)] p-1.5 sm:p-2 rounded-[2rem] border border-[var(--ease2event-border-subtle)] flex gap-1 shadow-inner relative z-20 w-full sm:w-auto overflow-hidden">
              {(['Daily', 'Weekly', 'Monthly'] as Period[]).map(period => (
                <button
                  ...
                  className={`flex-1 sm:flex-none px-4 sm:px-10 py-3 sm:py-4 text-[9px] sm:text-[11px] font-bold uppercase tracking-widest rounded-[1.5rem] transition-all duration-700 relative ${activePeriod === period ? 'bg-[var(--ease2event-brand-primary)] text-white shadow-2xl scale-105 z-10' : 'text-[var(--ease2event-text-secondary)] hover:text-[var(--ease2event-text-primary)]'}`}
                >
                  {period}
                </button>
              ))}
            ...
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={periodData} margin={{ top: 20, right: 20, left: 0, bottom: 0 }}>
                ...
                <Tooltip
                  ...
                  labelStyle={{ color: 'var(--ease2event-text-secondary)', fontWeight: 800, fontSize: '11px', marginBottom: '10px', textTransform: 'uppercase', letterSpacing: '0.3em' }}
        ...
        <motion.div variants={itemVariants} className="space-y-10">
          <div className="card-minimal p-10 bg-gradient-to-br from-[var(--ease2event-brand-primary)]/[0.04] to-transparent border-[var(--ease2event-border-base)] shadow-xl relative overflow-hidden group">
            <h3 className="text-2xl font-bold text-[var(--ease2event-text-primary)] mb-10 tracking-tight uppercase leading-none">Settlement Status</h3>
          ...
          <div className="card-minimal p-6 sm:p-10 hover:shadow-2xl transition-all duration-700 bg-[var(--ease2event-bg-surface)] border-[var(--ease2event-border-base)]">
            <div className="flex items-center gap-4 sm:gap-5 mb-8 sm:mb-10">
              ...
              <h3 className="font-bold text-[var(--ease2event-text-primary)] tracking-tight uppercase text-lg sm:text-xl leading-none">Net Optimization</h3>
            </div>
            <div className="space-y-6 sm:space-y-8">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 sm:gap-0 border-b border-[var(--ease2event-border-subtle)] pb-6 sm:pb-8">
                <div className="space-y-1.5 sm:space-y-2">
                  <p className="text-[10px] sm:text-[11px] font-bold text-[var(--ease2event-text-secondary)] uppercase tracking-[0.4em] mb-1 pl-1 leading-none">Fee deduction (Avg)</p>
                  <p className="font-bold text-4xl sm:text-5xl text-[var(--ease2event-text-primary)] leading-none">3.5%</p>
                </div>
                <Badge className="bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 font-bold uppercase text-[9px] sm:text-[10px] px-4 py-2 rounded-2xl tracking-[0.2em] shadow-sm leading-none shrink-0">GLOBAL_MINIMUM</Badge>
              </div>
              <p className="text-[10px] sm:text-[11px] text-[var(--ease2event-text-secondary)] font-bold uppercase tracking-widest leading-relaxed">
      ...
      <motion.div variants={itemVariants} className="card-minimal !p-0 overflow-hidden border-[var(--ease2event-border-base)] shadow-[0_48px_80px_-24px_rgba(0,0,0,0.15)] bg-[var(--ease2event-bg-surface)] rounded-[40px]">
        <div className="p-10 border-b border-[var(--ease2event-border-subtle)] bg-[var(--ease2event-bg-elevated)] flex flex-col xl:flex-row items-start xl:items-center justify-between gap-10">
          <div>
            <h3 className="text-4xl font-bold text-[var(--ease2event-text-primary)] tracking-tighter uppercase leading-none">Transactions</h3>
            <p className="text-[11px] text-[var(--ease2event-text-secondary)] font-bold uppercase mt-5 tracking-[0.2em]">Complete history of all payments and transfers</p>
          </div>
          <div className="flex gap-5 w-full xl:w-auto">
            <div className="relative flex-1 xl:w-96 group">
              ...
              <input
                ...
                className="w-full pl-16 pr-8 py-5 bg-[var(--ease2event-bg-surface)] border border-[var(--ease2event-border-subtle)] rounded-3xl text-[12px] font-bold outline-none focus:ring-4 focus:ring-[var(--ease2event-brand-primary)]/10 transition-all text-[var(--ease2event-text-primary)] uppercase tracking-widest placeholder:text-[var(--ease2event-text-secondary)]/40 shadow-inner"
              />
            </div>
          ...
          <table className="w-full text-left min-w-[1100px]">
            <thead>
              <tr className="bg-[var(--ease2event-bg-elevated)]/40 border-b border-[var(--ease2event-border-subtle)]">
                <th className="px-10 py-7 text-xs font-bold text-[var(--ease2event-text-secondary)] uppercase tracking-[0.3em]">Transaction ID</th>
                <th className="px-10 py-7 text-xs font-bold text-[var(--ease2event-text-secondary)] uppercase tracking-[0.3em]">Capture Volume</th>
                <th className="px-10 py-7 text-xs font-bold text-[var(--ease2event-text-secondary)] uppercase tracking-[0.3em]">Timestamp</th>
                <th className="px-10 py-7 text-xs font-bold text-[var(--ease2event-text-secondary)] uppercase tracking-[0.3em]">Protocol Status</th>
              </tr>
            </thead>
