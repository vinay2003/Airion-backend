...
const StatCard = ({ title, value, trend, period, unit, currency, direction, icon: Icon, color, bg }: any) => (
  <div className="card-premium flex flex-col justify-center">
    <div className="flex justify-between items-start mb-4">
      ...
      {trend && (
        <div className={`flex items-center gap-1 text-xs font-bold px-2 py-1 rounded-lg ${direction === 'up' ? 'text-[#06D6A0] bg-[rgba(6,214,160,0.15)]' : 'text-[#FF6B6B] bg-[rgba(255,107,107,0.1)]'}`}>
