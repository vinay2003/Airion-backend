...
const Layout: React.FC = () => {
    ...
    return (
        <div className="flex min-h-screen bg-[var(--airion-bg-base)] text-[var(--airion-text-primary)] font-sans antialiased overflow-hidden transition-colors duration-300">
