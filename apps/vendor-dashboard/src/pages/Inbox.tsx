                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    {viewMode === 'details' ? (
                                        <Button 
                                            ...
                                            className="rounded-full bg-blue-600 hover:bg-blue-700 text-white gap-2 h-10 px-6 font-black uppercase text-[10px] tracking-widest shadow-lg shadow-blue-500/20"
                                        >
                                            <MessageSquare size={14} /> Initialize Response
                                        </Button>
                                    ) : (
                                        <Button 
                                            variant="outline"
                                            onClick={() => setViewMode('details')}
                                            className="rounded-full border-blue-500/20 text-blue-500 gap-2 h-10 px-6 font-black uppercase text-[10px] tracking-widest"
                                        >
                                            <Info size={14} /> Lead Intelligence
                                        </Button>
                                    )}
                                </div>
                            </div>
                                    ...
                                    >
                                        <div className="flex justify-center">
                                            <div className="bg-[var(--ease2event-bg-surface)] border border-[var(--ease2event-border-subtle)] p-8 rounded-[2rem] max-w-xl w-full shadow-2xl relative overflow-hidden">
                                                 ...
                                                 <h4 className="text-xs font-black uppercase tracking-[0.3em] text-blue-500 mb-6 font-sans">Strategic Parameters</h4>
                                                 <div className="grid grid-cols-2 gap-8 mb-8">
                                                     <div>
                                                         <p className="text-[10px] font-black text-[var(--ease2event-text-muted)] uppercase tracking-widest mb-1">Target Date</p>
                                                     ...
                                                     <div>
                                                         <p className="text-[10px] font-black text-[var(--ease2event-text-muted)] uppercase tracking-widest mb-1">Guest Matrix</p>
                                                         <p className="text-lg font-bold text-[var(--ease2event-text-primary)]">{activeLead?.guestsCount || 'Not specified'}</p>
                                                     </div>
                                                 </div>
                                                 <div className="space-y-4">
                                                     <p className="text-[10px] font-black text-[var(--ease2event-text-muted)] uppercase tracking-widest leading-none">Transmission Notes</p>
                                                 ...
                                                 <div className="mt-8 pt-8 border-t border-[var(--ease2event-border-subtle)]/50">
                                                     <div className="flex items-start gap-4 text-emerald-500 bg-emerald-500/10 p-5 rounded-2xl border border-emerald-500/20">
                                                         ...
                                                         <div>
                                                             <p className="text-[10px] font-black uppercase tracking-widest mb-1">AI Reasoning Engine</p>
                                                ...
                                                messages.map((m: Message) => (
                                                    <div key={m.id} className={`flex ${m.senderId === user?.id ? 'justify-end' : 'justify-start'}`}>
                                                        ...
                                                        `}>
                                                            ...
                                                            <div className={`flex items-center gap-1.5 text-[9px] mt-2 font-black uppercase tracking-[0.15em] ${m.senderId === user?.id ? 'text-blue-100 justify-end' : 'text-[var(--ease2event-text-muted)]'}`}>
