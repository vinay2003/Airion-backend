...
const Earnings: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className="space-y-12 pb-32 px-6 sm:px-12 max-w-7xl mx-auto"
    >
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10 pt-0 pb-12 border-b border-[var(--ease2event-border-subtle)] relative overflow-hidden">
        <motion.div variants={itemVariants} className="relative z-10">
          <h1 className="text-3xl font-normal normal-case not- tracking-normal leading-normal">Financial Intelligence</h1>
          <div className="flex items-center gap-4 mt-4">
            ...
            <p className="text-base font-normal normal-case not- tracking-normal flex items-center gap-2">Liquidity Matrix • Revenue Protocol
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        <motion.div variants={itemVariants} whileHover={{ y: -8, scale: 1.02 }} className="card-minimal p-6 sm:p-10 flex flex-col justify-between hover:border-emerald-500/40 hover:shadow-2xl transition-all duration-500 bg-[var(--ease2event-bg-surface)]">
          <div>
            ...
            <p className="text-[var(--ease2event-text-muted)] font-black text-[10px] sm:text-[11px] uppercase tracking-[0.4em] mb-3 sm:mb-4 opacity-50 ">Secured Liquidity Node</p>
            <h2 className="text-4xl sm:text-5xl font-black text-[var(--ease2event-text-primary)] tracking-tighter leading-none  font-display">₹{displayData.totalBalance.toLocaleString('en-IN')}</h2>
          </div>
          <div className="mt-10 pt-8 border-t border-[var(--ease2event-border-subtle)]">
            <button className="flex items-center justify-between w-full p-5 bg-[var(--ease2event-bg-surface)] hover:bg-[var(--ease2event-bg-elevated)] border-2 border-[var(--ease2event-border-subtle)] rounded-[2rem] transition-all group active:scale-95 shadow-inner hover:border-emerald-500/30">
              <span className="text-[11px] font-black text-[var(--ease2event-text-primary)] uppercase tracking-widest  flex items-center gap-3">
        ...
        <motion.div variants={itemVariants} whileHover={{ y: -8, scale: 1.02 }} className="card-minimal p-6 sm:p-10 flex flex-col justify-between hover:border-[var(--ease2event-brand-primary)]/40 hover:shadow-2xl transition-all duration-500 bg-[var(--ease2event-bg-surface)]">
          <div>
            ...
            <p className="text-[var(--ease2event-text-muted)] font-black text-[10px] sm:text-[11px] uppercase tracking-[0.4em] mb-3 sm:mb-4 opacity-50 ">{activePeriod} Gross Delta</p>
            <h2 className="text-4xl sm:text-5xl font-black text-[var(--ease2event-text-primary)] tracking-tighter leading-none  font-display">₹{displayData.periodRevenue.toLocaleString('en-IN')}</h2>
          </div>
          <div className="flex items-center gap-4 mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-[var(--ease2event-border-subtle)]">
            ...
            <p className="text-[9px] sm:text-[10px] text-[var(--ease2event-text-muted)] font-black uppercase tracking-[0.2em]  opacity-60 leading-none">Nodes Updated <span className="text-emerald-500">Live Telemetry</span></p>
          </div>
        </motion.div>
        ...
        <motion.div variants={itemVariants} whileHover={{ y: -8, scale: 1.02 }} className="card-minimal p-6 sm:p-10 flex flex-col justify-between hover:border-amber-500/40 hover:shadow-2xl transition-all duration-500 bg-[var(--ease2event-bg-surface)]">
          <div className="flex justify-between items-start mb-6 sm:mb-8">
            <div className="flex-1">
              <p className="text-[var(--ease2event-text-muted)] font-black text-[10px] sm:text-[11px] uppercase tracking-[0.4em] mb-1 sm:mb-2 opacity-50 ">Target Matrix</p>
              <h3 className="text-2xl sm:text-3xl font-black text-[var(--ease2event-text-primary)] tracking-tighter  font-display uppercase leading-none">₹{displayData.payoutTarget.toLocaleString()} GOAL</h3>
            </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex justify-between items-center text-[8px] sm:text-[10px] font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-[var(--ease2event-text-muted)]  leading-none">
          ...
          <button className="mt-8 sm:mt-10 flex items-center justify-between w-full p-4 sm:p-5 bg-[var(--ease2event-bg-surface)] hover:bg-[var(--ease2event-bg-elevated)] border-2 border-[var(--ease2event-border-subtle)] rounded-[1.5rem] sm:rounded-[2rem] transition-all group active:scale-95 shadow-inner">
            <span className="text-[10px] sm:text-[11px] font-black text-[var(--ease2event-text-primary)] uppercase tracking-widest  leading-none">Modify Target Matrix</span>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-10">
        <motion.div variants={itemVariants} className="xl:col-span-2 card-minimal !p-10 flex flex-col bg-[var(--ease2event-bg-surface)] shadow-2xl overflow-hidden relative">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-10 mb-16 relative z-10">
            <div>
              <h3 className="text-3xl font-black text-[var(--ease2event-text-primary)] tracking-tight  font-display uppercase leading-none">Revenue Trajectory</h3>
              <p className="text-[11px] text-[var(--ease2event-text-muted)] font-black uppercase tracking-[0.4em] mt-4 opacity-50 ">High-Fidelity Performance Monitoring</p>
            </div>
            <div className="bg-[var(--ease2event-bg-elevated)] p-1.5 sm:p-2 rounded-[2rem] border border-[var(--ease2event-border-subtle)] flex gap-1 shadow-inner relative z-20 w-full sm:w-auto overflow-hidden">
              {(['Daily', 'Weekly', 'Monthly'] as Period[]).map(period => (
                <button
                  ...
                  className={`flex-1 sm:flex-none px-4 sm:px-10 py-3 sm:py-4 text-[9px] sm:text-[11px] font-black uppercase tracking-widest rounded-[1.5rem] transition-all duration-700  relative ${activePeriod === period ? 'bg-[var(--ease2event-brand-primary)] text-white shadow-2xl shadow-[var(--ease2event-brand-primary)]/30 scale-105 z-10' : 'text-[var(--ease2event-text-muted)] hover:text-[var(--ease2event-text-primary)]'}`}
                >
                  {period}
                </button>
              ))}
            ...
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={periodData} margin={{ top: 20, right: 20, left: 0, bottom: 0 }}>
                ...
                <Tooltip
                  ...
                  itemStyle={{ color: 'var(--ease2event-brand-primary)', fontWeight: 900, fontSize: '24px', fontStyle: '', letterSpacing: '-0.02em' }}
                  labelStyle={{ color: 'var(--ease2event-text-muted)', fontWeight: 900, fontSize: '11px', marginBottom: '10px', textTransform: 'uppercase', letterSpacing: '0.3em', fontStyle: '' }}
        ...
        <motion.div variants={itemVariants} className="space-y-10">
          <div className="card-minimal p-10 bg-gradient-to-br from-[var(--ease2event-brand-primary)]/[0.04] to-transparent border-[var(--ease2event-border-base)] shadow-xl relative overflow-hidden group">
            ...
            <h3 className="text-2xl font-black text-[var(--ease2event-text-primary)] mb-10 tracking-tighter  font-display uppercase leading-none">Settlement Matrix</h3>
                ...
                <div key={idx} className="flex items-start justify-between group/item">
                  <div className="flex gap-6">
                    ...
                    <div className="space-y-1.5 pt-1">
                      <p className="text-[11px] font-black text-[var(--ease2event-text-primary)] uppercase tracking-tight ">{item.label}</p>
                      <p className="text-[10px] font-black text-[var(--ease2event-text-muted)] uppercase tracking-[0.3em] opacity-50 ">{item.date}</p>
                    </div>
                  </div>
                  <span className="text-lg font-black text-[var(--ease2event-text-primary)]  font-display pt-1">{item.amount}</span>
                </div>
              ))}
            </div>
            <button className="w-full mt-12 py-5 bg-[var(--ease2event-bg-surface)] border-2 border-[var(--ease2event-border-subtle)] rounded-[1.5rem] text-xs font-black uppercase tracking-[0.2em] text-[var(--ease2event-text-muted)] hover:text-[var(--ease2event-brand-primary)] hover:border-[var(--ease2event-brand-primary)]/40 hover:shadow-xl transition-all font-display  active:scale-95 shadow-inner">
              Access Ledger Logs
            </button>
          </div>
          ...
          <div className="card-minimal p-6 sm:p-10 hover:shadow-2xl transition-all duration-700 bg-[var(--ease2event-bg-surface)] border-[var(--ease2event-border-base)]">
            <div className="flex items-center gap-4 sm:gap-5 mb-8 sm:mb-10">
              ...
              <h3 className="font-black text-[var(--ease2event-text-primary)] tracking-tight  uppercase text-lg sm:text-xl font-display leading-none">Net Optimization</h3>
            </div>
            <div className="space-y-6 sm:space-y-8">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 sm:gap-0 border-b border-[var(--ease2event-border-subtle)] pb-6 sm:pb-8">
                <div className="space-y-1.5 sm:space-y-2">
                  <p className="text-[10px] sm:text-[11px] font-black text-[var(--ease2event-text-muted)] uppercase tracking-[0.4em] mb-1 pl-1  leading-none opacity-50">Fee deduction (Avg)</p>
                  <p className="font-black text-4xl sm:text-5xl text-[var(--ease2event-text-primary)]  font-display leading-none">3.5%</p>
                </div>
                <Badge className="bg-emerald-500/10 text-emerald-600 border border-emerald-500/20  font-black uppercase text-[9px] sm:text-[10px] px-4 py-2 rounded-2xl tracking-[0.2em] shadow-sm leading-none shrink-0">GLOBAL_MINIMUM</Badge>
              </div>
              <p className="text-[10px] sm:text-[11px] text-[var(--ease2event-text-muted)] font-black uppercase  tracking-tighter leading-relaxed opacity-60">
      ...
      <motion.div variants={itemVariants} className="card-minimal !p-0 overflow-hidden border-[var(--ease2event-border-base)] shadow-[0_48px_80px_-24px_rgba(0,0,0,0.15)] bg-[var(--ease2event-bg-surface)] rounded-[40px]">
        <div className="p-10 border-b border-[var(--ease2event-border-subtle)] bg-[var(--ease2event-bg-elevated)] flex flex-col xl:flex-row items-start xl:items-center justify-between gap-10">
          <div>
            <h3 className="text-4xl font-black text-[var(--ease2event-text-primary)] tracking-tighter uppercase  font-display leading-none">Transaction Registry</h3>
            <p className="text-[11px] text-[var(--ease2event-text-muted)] font-black uppercase mt-5 tracking-[0.5em]  opacity-50">Complete Settlement Audit Logs • Verified Nodes</p>
          </div>
          <div className="flex gap-5 w-full xl:w-auto">
            <div className="relative flex-1 xl:w-96 group">
              ...
              <input
                ...
                className="w-full pl-16 pr-8 py-5 bg-[var(--ease2event-bg-surface)] border border-[var(--ease2event-border-subtle)] rounded-3xl text-[12px] font-black  outline-none focus:ring-4 focus:ring-[var(--ease2event-brand-primary)]/10 transition-all text-[var(--ease2event-text-primary)] uppercase tracking-widest placeholder:text-[var(--ease2event-text-muted)]/40 shadow-inner"
              />
            </div>
          ...
          <table className="w-full text-left min-w-[1100px]">
            <thead>
              <tr className="bg-[var(--ease2event-bg-elevated)]/40 border-b border-[var(--ease2event-border-subtle)]">
                <th className="px-12 py-8 text-[11px] font-black text-[var(--ease2event-text-muted)] uppercase tracking-[0.4em] ">Node ID</th>
                <th className="px-12 py-8 text-[11px] font-black text-[var(--ease2event-text-muted)] uppercase tracking-[0.4em] ">Operational Protocol</th>
                <th className="px-12 py-8 text-[11px] font-black text-[var(--ease2event-text-muted)] uppercase tracking-[0.4em] ">Capture Source</th>
                <th className="px-12 py-8 text-[11px] font-black text-[var(--ease2event-text-muted)] uppercase tracking-[0.4em] ">Timestamp</th>
                <th className="px-12 py-8 text-[11px] font-black text-[var(--ease2event-text-muted)] uppercase tracking-[0.4em] ">Capture Method</th>
                <th className="px-12 py-8 text-[11px] font-black text-[var(--ease2event-text-muted)] uppercase tracking-[0.4em] ">Gross Capture</th>
                <th className="px-12 py-8 text-[11px] font-black text-[var(--ease2event-text-muted)] uppercase tracking-[0.4em]  text-center">Status</th>
              </tr>
            </thead>
              ...
              <AnimatePresence mode="popLayout">
                {displayData.transactions.map((trx: any, tIdx: number) => (
                  ...
                  >
                    ...
                    <td className="px-12 py-10 font-black text-sm text-[var(--ease2event-text-primary)]  tracking-tight uppercase group-hover:translate-x-3 transition-transform duration-1000">
                    ...
                    <td className="px-12 py-10 text-[11px] font-black text-[var(--ease2event-text-primary)] uppercase tracking-widest  opacity-70 group-hover:opacity-100 transition-opacity">{trx.client}</td>
                    <td className="px-12 py-10 text-[var(--ease2event-text-muted)] text-[10px] font-black uppercase tracking-[0.2em]  opacity-60">{trx.date}</td>
                    <td className="px-12 py-10">
                    ...
                    <td className="px-12 py-10">
                      <div className="flex justify-center translate-y-0 group-hover:-translate-y-1 transition-transform duration-500">
                        <Badge
                          className={` font-black text-[10px] px-6 py-2.5 rounded-2xl uppercase tracking-[0.3em] border shadow-md transition-all duration-700 ${trx.status.toLowerCase() === 'completed' ? 'bg-emerald-500/10 text-emerald-600 border-emerald-500/20 shadow-emerald-500/5' :
        ...
        <div className="p-12 bg-[var(--ease2event-bg-elevated)]/20 border-t border-[var(--ease2event-border-subtle)]">
          <button className="flex items-center justify-center gap-5 w-full py-6 rounded-[32px] bg-[var(--ease2event-bg-surface)] hover:bg-[var(--ease2event-bg-elevated)] text-[var(--ease2event-text-primary)] text-[12px] font-black hover:gap-8 transition-all uppercase tracking-[0.5em] border border-[var(--ease2event-border-base)] shadow-2xl active:scale-[0.99]  group/btn">
