...
const Ads: React.FC = () => {
 ...
 <div className="h-2 w-0 group-hover:w-full bg-blue-600 transition-all absolute bottom-0 left-0 " />
 </div>
 ))}
 </div>
 )}
 ...
 className="card-minimal p-4 sm:p-5 md:!p-12 max-w-3xl w-full border-2 border-[var(--ease2event-border-base)] relative rounded-xl sm:rounded-xl bg-[var(--ease2event-bg-surface)] my-auto"
