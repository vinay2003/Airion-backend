    ...
    return (
        <div className="space-y-12 animate-in fade-in duration-700 pb-24">
            <header className="space-y-4 border-b border-[var(--ease2event-border-subtle)] pb-10">
                <h1 className="text-4xl font-bold text-[var(--ease2event-text-primary)] tracking-tight leading-loose uppercase">Ads & Promotions</h1>
                <p className="text-lg font-bold text-[var(--ease2event-text-muted)]">Boost your visibility and get more bookings with our premium promotion tools.</p>
            </header>

            {/* Active Campaigns */}
            <div className="card-minimal !p-10 shadow-xl border-[var(--ease2event-border-base)] rounded-[2.5rem]">
                <h2 className="text-2xl font-bold text-[var(--ease2event-text-primary)] mb-8 uppercase tracking-wider">Active Campaigns</h2>
                <div className="p-16 text-center bg-[var(--ease2event-bg-elevated)] rounded-[2rem] border-2 border-dashed border-[var(--ease2event-border-subtle)] space-y-6">
                    ...
                    <div className="max-w-md mx-auto space-y-3">
                        <h3 className="text-xl font-bold text-[var(--ease2event-text-primary)] uppercase">Scale Your Growth</h3>
                        <p className="text-sm text-[var(--ease2event-text-muted)] font-semibold uppercase tracking-tight opacity-80">You don't have any active campaigns running.</p>
                    </div>
            ...
            <div className="space-y-10">
                <h2 className="text-2xl font-bold text-[var(--ease2event-text-primary)] uppercase tracking-wider pl-2">Promotion Packages</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold text-[var(--ease2event-text-primary)] mb-3 uppercase tracking-tight">Featured Listing</h3>
                        <p className="text-[var(--ease2event-text-muted)] text-sm font-semibold mb-6 uppercase tracking-tight opacity-80">Get top placement in your category search results.</p>
                        <div className="text-4xl font-bold text-[var(--ease2event-text-primary)] mb-10 tracking-tighter">₹999<span className="text-sm font-bold text-[var(--ease2event-text-muted)] ml-2 uppercase tracking-widest">/week</span></div>
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold text-[var(--ease2event-text-primary)] mb-3 uppercase tracking-tight">Homepage Banner</h3>
                        <p className="text-[var(--ease2event-text-muted)] text-sm font-semibold mb-6 uppercase tracking-tight opacity-80">Display your banner on the main homepage carousel.</p>
                        <div className="text-4xl font-bold text-[var(--ease2event-text-primary)] mb-10 tracking-tighter">₹2,499<span className="text-sm font-bold text-[var(--ease2event-text-muted)] ml-2 uppercase tracking-widest">/week</span></div>
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold text-[var(--ease2event-text-primary)] mb-3 uppercase tracking-tight">Sponsored Package</h3>
                        <p className="text-[var(--ease2event-text-muted)] text-sm font-semibold mb-6 uppercase tracking-tight opacity-80">Promote your special packages in the Packages section.</p>
                        <div className="text-4xl font-bold text-[var(--ease2event-text-primary)] mb-10 tracking-tighter">₹1,499<span className="text-sm font-bold text-[var(--ease2event-text-muted)] ml-2 uppercase tracking-widest">/week</span></div>
            ...
            <div className="mt-12 bg-[var(--ease2event-bg-surface)] border border-[var(--ease2event-border-base)] shadow-2xl rounded-[3rem] p-12 flex flex-col md:flex-row items-center justify-between gap-10">
                <div className="space-y-5 flex-1">
                    <h3 className="text-3xl font-bold text-[var(--ease2event-text-primary)] uppercase tracking-tight italic">Track Your Performance</h3>
                    <p className="text-[var(--ease2event-text-muted)] text-lg font-semibold max-w-xl leading-relaxed">Get detailed insights into how your ads are performing with real-time analytics dashboards.</p>
                </div>
                <div className="flex gap-12 bg-[var(--ease2event-bg-elevated)] px-12 py-8 rounded-[2rem] border border-[var(--ease2event-border-subtle)]">
                    <div className="text-center space-y-2">
                        ...
                        <div className="text-xs font-bold text-[var(--ease2event-text-muted)] uppercase tracking-widest">Avg CTR</div>
                    </div>
                    <div className="text-center space-y-2">
                        <div className="text-3xl font-bold text-emerald-500 italic">12x</div>
                        <div className="text-xs font-bold text-[var(--ease2event-text-muted)] uppercase tracking-widest">ROI</div>
                    </div>
                </div>
            </div>
        </div>
