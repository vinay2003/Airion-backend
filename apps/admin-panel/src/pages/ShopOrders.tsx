...
const ShopOrders = () => {
    ...
    return (
        <div className="p-8">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 p-4 mb-6 flex flex-wrap gap-4">
                <div className="flex-1 min-w-[250px] relative">
                    ...
                    <input 
                        ...
                        className="w-full pl-10 pr-4 py-2 rounded-xl bg-gray-50 dark:bg-slate-800 border-transparent text-gray-900 dark:text-white focus:bg-white dark:focus:bg-slate-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition-all"
                    />
                </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 overflow-hidden">
                <table className="w-full text-left">
                    <thead className="bg-gray-50 dark:bg-slate-800/50 text-gray-500 dark:text-slate-400 font-bold text-xs uppercase tracking-wider">
                        <tr>
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-slate-800">
                        {filtered.length === 0 ? (
                            ...
                            <tr key={order.id} className="transition-colors hover:bg-gray-50 dark:hover:bg-slate-800/50">
                                <td className="p-4">
                                    <div className="font-bold text-gray-900 dark:text-white">ORD-{order.id.substring(0,8).toUpperCase()}</div>
                                ...
                                <td className="p-4">
                                    <span className={`px-2.5 py-1 text-xs font-bold rounded-lg ${
                                        ...
                                        order.status === 'CANCELLED' ? 'bg-rose-100 text-rose-700 dark:bg-rose-500/20 dark:text-rose-400' :
