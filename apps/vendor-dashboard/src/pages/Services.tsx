                    ...
                    <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full min-h-[90px] bg-[var(--ease2event-bg-elevated)]/50 border border-[var(--ease2event-border-subtle)] rounded-3xl px-6 py-5 text-sm font-bold leading-relaxed outline-none focus:ring-2 focus:ring-[var(--ease2event-brand-primary)]/20 transition-all text-[var(--ease2event-text-primary)]"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="card-minimal p-6 space-y-6 bg-[var(--ease2event-bg-surface)]">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-xs text-[var(--ease2event-text-secondary)] font-semibold">Press enter to add a feature</p>
                ...
                <div className="flex gap-8 overflow-x-auto no-scrollbar">
                    {['ALL_SERVICES', 'ACTIVE', 'ARCHIVED'].map(tab => (
                        <button
                            ...
                            className={`pb-4 pt-2 font-bold text-xs tracking-widest relative group whitespace-nowrap transition-colors ${activeTab === tab ? 'text-red-500' : 'text-[var(--ease2event-text-secondary)] hover:text-[var(--ease2event-text-primary)]'
                                }`}
                        >
